...
--
-- Host: localhost:3306
-- Generation Time: Dec 17, 2025 at 04:15 AM
...
(1, 'TES GRANTEES PAYROLL RELEASE', 'sdguawv utrv cweutuewtutuweiewu', 1, '2025-12-17 03:35:38', NULL),
(2, 'TES GRANTEES', 'sdfasfetrwtyeryERTUYFNDHDH', 1, '2025-12-17 03:35:58', NULL),
(3, 'TES GRANTEES', 'sdfasfetrwtyeryERTUYFNDHDH', 1, '2025-12-17 03:38:12', NULL),
(4, 'TES GRANTEES', 'sdfasfetrwtyeryERTUYFNDHDH', 1, '2025-12-17 03:39:43', NULL),
(5, 'TES GRANTEES', 'sdfasfetrwtyeryERTUYFNDHDH', 1, '2025-12-17 03:43:58', NULL),
(6, 'new logo', 'hdiuSGDUSAGFDJSBFASGFSGAUFGJSDBJSBD', 1, '2025-12-17 04:09:05', NULL),
(7, 'TEST', 'ASFSDGSGHDR', 1, '2025-12-17 04:12:19', NULL);
...
(1, 'admin', '$2y$10$0yaRL5K1Q2Lc8jqnkRK1seLHPx1CbkCFbnzpIpl8bYB8P/kIJOmU.', 'Admin Ko', 'admin@gmail.com', 'user', '2025-12-17 02:58:39'),
...
--
ALTER TABLE `announcements`
  MODIFY `announcement_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
